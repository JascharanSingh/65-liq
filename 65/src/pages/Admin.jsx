...
const categoryMap = {
  ...
  "Seltzer & Hard Beverages": [
    "Hard Seltzer",
    "Ready to Drink Cocktails & Shots",
  ],
  Vodka: [],
...
export default function Admin() {
  ...
  const handleSubmit = () => {
    ...
    const url = editingProductId
      ? `${backendUrl}/api/products/${editingProductId}`
    ...
    fetch(url, {
      ...
      .then(() => {
        alert("✅ Product saved");
        return fetch(`${backendUrl}/api/products`, {
          credentials: "include",
        });
      })
      .then((res) => res.json())
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-white shadow rounded relative">
      ...
      <h2 className="text-2xl font-bold mb-4">
        {editingProductId ? "Edit" : "Add / Edit Liquor Product"}
      </h2>
